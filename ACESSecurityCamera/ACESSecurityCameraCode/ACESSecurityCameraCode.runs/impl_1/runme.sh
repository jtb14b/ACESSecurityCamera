...
HD_PWD='C:/Users/jtb14b/ACESSecurityCamera/ACESSecurityCameraCode/ACESSecurityCameraCode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SecurityCameraCode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SecurityCameraCode.tcl -notrace
