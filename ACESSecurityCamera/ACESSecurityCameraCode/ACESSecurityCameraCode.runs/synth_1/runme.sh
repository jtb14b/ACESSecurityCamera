...
HD_PWD='C:/Users/jtb14b/ACESSecurityCamera/ACESSecurityCameraCode/ACESSecurityCameraCode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SecurityCameraCode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SecurityCameraCode.tcl
